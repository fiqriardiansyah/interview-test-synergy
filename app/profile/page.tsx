        ...
        <div className="container mx-auto px-8 pb-24">
            ...
            <div className="grid grid-cols-1 md:gap-10 md:grid-cols-2 gap-5 ">
                <Card
                    ...
                    desc={`$${profile.data?.goals?.emergencyFund}`}
                    action={<Button className="text-sm md:text-base">edit</Button>}
                />
                <Card
                    image="/example.png"
                    title="travel"
                    desc={`$${profile.data?.goals?.travel}`}
                    action={<Button className="text-sm md:text-base">edit</Button>}
                />
            </div>
            ...
            <div className="grid grid-cols-1 md:gap-10 md:grid-cols-2 gap-5 ">
                <Card
                    ...
                    desc={`Plan A . $${profile.data?.insurances?.lifeInsurance}`}
                    action={<Button className="text-xs md:text-base">view insurance</Button>}
                />
                <Card
                    image="/example.png"
                    title="personal accident"
                    desc={`Plan A . $${profile.data?.insurances?.personalAccident}`}
                    action={<Button className="text-xs md:text-base">view insurance</Button>}
                />
            </div>
        </div>
